...
def extract_tiles(img):
    """
    从输入图像中提取麻将牌图像，并在原图上绘制边界框。
    :param img: 输入的麻将桌面图像
    :return: 切割出的麻将牌图像列表，带框的原图
    """
...
if __name__ == '__main__':
    img = cv2.imread('Data\\recogition\output_first\phone\\third_Mingpai_phone.jpg')  # 请替换为实际图片路径
    ...
    for i, tile in enumerate(tiles):
        tile_path = f'Data/recogition/output_final/lx/{i}.png'
